...
DROP POLICY IF EXISTS "super_admins_full_access_sin_requests" ON sin_change_requests;
...
DROP POLICY IF EXISTS "admins_own_requests" ON sin_change_requests;
...
DROP POLICY IF EXISTS "admins_create_requests" ON sin_change_requests;
...
DROP POLICY IF EXISTS "super_admins_full_access_api_keys" ON api_keys;
