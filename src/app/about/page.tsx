            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12 overflow-hidden">
                ...
                <div className="mb-24">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {systemInfo.map((info, i) => (
                            <div key={i} className="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgb(255,255,255,0.05)] group">
                ...
                <div className="mb-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                        {team.map((member, index) => (
                            <div
                                key={index}
                                className="group relative bg-white dark:bg-gray-800 rounded-[2rem] p-8 shadow-xl border border-gray-100 dark:border-gray-700 hover:border-transparent transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl dark:hover:shadow-[0_4px_20px_rgb(255,255,255,0.05)]"
                            >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-32">
                    {[
                        ...
                        <div key={i} className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm p-6 rounded-2xl border border-gray-100 dark:border-gray-700 text-center hover:bg-white dark:hover:bg-gray-800 transition-all duration-300 hover:-translate-y-1 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgb(255,255,255,0.05)]">
