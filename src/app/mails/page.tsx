...
export default function MailsPage() {
    ...
    const loadItems = async () => {
        ...
        let query = supabase
            ...
            .select("id, file_name, file_url, file_type, description, status, created_at, class_id, students(name, sin, year_level), evidence_date_links(absence_date)")
        ...
        const channel = supabase
            ...
            .on(
                ...
                (payload: { eventType: string }) => {
                    console.log('📬 [MailsPage] Change detected:', payload.eventType);
