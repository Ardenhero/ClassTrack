      ...
      <div className="portal-about-container relative">
        ...
        <section id="hardware">
           <div className="si" style={{padding:'0 52px'}}>
            ...
            <h2 className="stit">Hardware Components</h2>
