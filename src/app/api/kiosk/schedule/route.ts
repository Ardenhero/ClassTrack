...
export async function GET(request: Request) {
    ...
    try {
        ...
        // todayDay is defined later near the filter logic as it's more robust there.
        ...
        const todayDay = manilaDate.toLocaleDateString('en-US', { weekday: 'long' });
        ...
        const todayClasses = (classes || [])
            ...
            .map((c: any) => {
                ...
                const isActualInstructor = inst?.role === 'instructor';
                ...
                return {
                    ...
                    instructor_name: isActualInstructor ? (inst?.name || 'Unknown') : 'Unknown Instructor',
