...
interface Props {
    ...
    onSave: (entityId: string, selectedIds: string[]) => Promise<unknown>;
    isSuperAdmin?: boolean;
}

export function DeviceInstructorSelector({ entityId, assignedIds, instructors, onSave, isSuperAdmin }: Props) {
    ...
    const handleSave = async () => {
        setSaving(true);
        try {
            await onSave(entityId, tempSelectedIds);
