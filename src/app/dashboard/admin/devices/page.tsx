...
function DevicesSkeleton() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[40vh] space-y-4">
            <p className="text-gray-500 text-sm animate-pulse">Loading device registry...</p>
        </div>
    );
}
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 p-6">
                    ...
                    <form action={async (formData: FormData) => {
                        ...
                        <div className="md:col-span-1">
                            ...
                            <select name="dp_code" className="w-full px-3 py-2 text-sm border rounded-lg dark:bg-gray-900 border-gray-200 dark:border-gray-600">
                                <option value="switch_1">switch_1</option>
                                <option value="switch_2">switch_2</option>
                            </select>
                        </div>
                        <div className="md:col-span-1">
