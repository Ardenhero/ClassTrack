...
export default function SecurityPage() {
    ...
    useEffect(() => {
        async function loadTargets() {
            ...
            // Load instructors for PIN reset — scoped to department for Dept Admins
            ...
            // Scope: show only instructors in the same department
            if (!isSuperAdmin && profile?.department_id) {
                instructorQuery = instructorQuery.eq("department_id", profile.department_id);
            }
    ...
    }, [profile?.id, profile?.department_id, isSuperAdmin, supabase]);
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {isSuperAdmin && (
                    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md dark:hover:shadow-[0_4px_20px_rgb(255,255,255,0.05)]">
