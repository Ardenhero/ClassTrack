...
import { createInstructor } from "./instructorActions";
...
export default async function InstructorsPage() {
    ...
    return (
        <div className="space-y-8">
            {/* Add Instructor Form */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 p-6 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-[0_4px_20px_rgb(255,255,255,0.05)]">
                ...
                <form action={addInstructor} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            name="name"
                            required
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-nwu-red focus:border-transparent transition-all text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
                    ...
                    {isSuperAdmin && (
                        <div>
                            ...
                            <select name="department_id" className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-nwu-red focus:border-transparent transition-all text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">PIN Code (optional)</label>
                        <input
                            name="pin_code"
                            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-nwu-red focus:border-transparent transition-all text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white"
                    ...
                    <div>
                        ...
                        <select name="role" className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-nwu-red focus:border-transparent transition-all text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 p-6 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-[0_4px_20px_rgb(255,255,255,0.05)]">
                ...
                <Suspense fallback={<InstructorsSkeleton />}>
                    <InstructorListContent isSuperAdmin={isSuperAdmin} userId={user?.id} profileId={profileId} />
                </Suspense>
            </div>
        </div>
    );
