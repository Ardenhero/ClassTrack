    ...
    return (
        <>
            ...
            <ConfirmationModal
                ...
                title={`Declare ${type === 'holiday' ? 'Holiday' : 'Suspended Classes'}`}
                message={`Declare ${type === 'holiday' ? 'Holiday' : 'Suspended Classes'} for ${selectedDate}?\n\nThis will mark ALL active classes as "No Class" for this date.`}
                variant="warning"
                confirmLabel="Confirm Declaration"
            />
        </>
    );
}
